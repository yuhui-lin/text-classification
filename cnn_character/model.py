...
def inputs_train():
  ...
  """
    return input.inputs_character("train", FLAGS.minibatch_size, FLAGS.num_epochs, min_shuffle=1000)


def inputs_eval(eval_data):
  ...
  """
    # don't shuffle
    return input.inputs_character("test", FLAGS.minibatch_size, None, min_shuffle=1)
...
def inference(sequences):
  ...
  """
    ...
    with tf.variable_scope('conv1') as scope:
        ...
        biases = _variable_on_cpu('biases', [FEATURE_NUM], tf.constant_initializer(0.02))
